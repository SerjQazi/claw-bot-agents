...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ...
    ['beds'] = {
        { coords = vector4(310.92, -583.38, 44.2, 342.15),    taken = false, model = 1631638868 },
        { coords = vector4(314.55, -586.66, 44.2, 168.04),  taken = false, model = 1631638868 },
        { coords = vector4(317.8, -585.32, 44.2, 158.02),   taken = false, model = 2117668672 },
        { coords = vector4(319.32, -581.0, 44.2, 162.21),    taken = false, model = 2117668672 },
        { coords = vector4(313.92, -578.97, 44.2, 152.83),   taken = false, model = 2117668672 },
        { coords = vector4(307.73, -581.7, 44.2, 350.59),  taken = false, model = -1091386327 },
        { coords = vector4(309.39, -577.29, 44.2, 158.93),  taken = false, model = -1091386327 },
        { coords = vector4(324.12, -583.38, 44.2, 342.59),  taken = false, model = -1091386327 },
        --- paleto
