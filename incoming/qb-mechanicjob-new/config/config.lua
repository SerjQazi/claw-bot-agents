...
Config.Shops = {
    ...
    --     },
    -- },
    mosely = { -- Mosely Location
        managed = true,
        shopLabel = 'Mosely',
        showBlip = true,
        blipSprite = 853,
        blipColor = 48,
        blipCoords = vector4(-16.79, -1662.02, 29.49, 68.92),
        duty = vector4(-18.67, -1650.42, 29.49, 43.21),
        stash = vector4(-2.38, -1656.14, 29.49, 316.11),
        paint = vector4(-11.07, -1652.84, 29.51, 147.31),
        vehicles = {
            withdraw = vector4(-32.03, -1673.63, 29.49, 70.57),
            spawn = vector4(-25.05, -1679.56, 29.44, 197.36),
            list = { 'flatbed', 'towtruck', 'minivan', 'blista' }
        },
    },
